<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{invalid: !areas.isValid}">
            ...
            <div>
                <input type="checkbox" id="realistic" value="realistic" v-model="areas.val" @blur="clearValidity('areas')"/>
                <label for="realistic">Realistic</label>
            </div>
            <div>
                <input type="checkbox" id="anime" value="anime" v-model="areas.val" @blur="clearValidity('areas')"/>
                <label for="anime">Anime</label>
            </div>
            <div>
                <input type="checkbox" id="chibi" value="chibi" v-model="areas.val" @blur="clearValidity('areas')"/>
                <label for="chibi">Chibi</label>
            </div>
            <div>
                <input type="checkbox" id="mecha" value="mecha" v-model="areas.val" @blur="clearValidity('areas')" />
